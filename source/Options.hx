...
class TvOption extends Option
{
	...
	public override function press():Bool
	{
		FlxG.save.data.tvFilterSlender = !FlxG.save.data.tvFilterSlender;
		FlxG.save.data.tvWhiteSlender = !FlxG.save.data.tvWhiteSlender;
		trace(FlxG.save.data.tvWhiteSlender);
		trace(FlxG.save.data.tvFilterSlender);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.tvFilterSlender ? "crt filter on" : "crt filter off";
	}
}

class CamOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.UIcamSlender = !FlxG.save.data.UIcamSlender;
		trace(FlxG.save.data.UIcamSlender);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.UIcamSlender ? "camera ui on" : "camera ui off";
	}
}

class JSOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.JumpScareSlender = !FlxG.save.data.JumpScareSlender;
		trace(FlxG.save.data.JumpScareSlender);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.JumpScareSlender ? "JumpScares on" : "JumpScares off";
	}
}

class OsuOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.osuOverlay = !FlxG.save.data.osuOverlay;
		trace(FlxG.save.data.osuOverlay);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.osuOverlay ? "osumania overlay on" : "osumania overlay off";
	}
}

//crit rate

class CritRateOption extends Option
{
	public function new(desc:String)
	{
		super();
		...
		private override function updateDisplay() : String
	{
		...
		override function right() : Bool{
			if (FlxG.save.data.critVar >= 100)
			{
				FlxG.save.data.critVar = 1;
			}
			else
				FlxG.save.data.critVar = FlxG.save.data.critVar + 10;

			return true;
	}

		override function left() :Bool{
			if (FlxG.save.data.critVar <= 1)
			{
				FlxG.save.data.critVar = 100;
			}
			else
				FlxG.save.data.critVar = FlxG.save.data.critVar - 10;
		...
		override function getValue() :String
	{
		return "Current value: " + (100 - FlxG.save.data.critVar);
	}
}

//github bullshit
class GitHubOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.gitWarning = !FlxG.save.data.gitWarning;
		trace(FlxG.save.data.gitWarning);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.gitWarning ? "notification on" : "notification off";
	}
}

//freeplay gimmicks
class GimmickInvertOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.canSwitch = !FlxG.save.data.canSwitch;
		trace(FlxG.save.data.canSwitch);
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return FlxG.save.data.canSwitch ? "key inversion on" : "key inversion off";
	}
}
