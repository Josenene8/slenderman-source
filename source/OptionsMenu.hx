...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("overlays and jumpscares", [
			//new OsuOption("Toggle osu!mania green/magenta overlay."),
			new TvOption("Toggle the CRT TV filter in Week S."),
			//new TvWhiteOption("Toggle the moving white scanline in Week S."),
			new CamOption("Toggle the camera UI in Week S."),
			new JSOption("Toggle the jumpscares and eventual statics in Static and Engage.")
		]),

		new OptionCategory("freeplay gimmicks", [
			new GimmickInvertOption("Toggle the eventual key inversion.")
		]),
		...
		new OptionCategory("Misc", [
			...
			new GitHubOption("Toggle the new GitHub version notification in the main menu."),
