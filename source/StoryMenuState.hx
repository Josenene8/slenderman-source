...
{	
	...
	var weekNames:Array<String> = CoolUtil.coolTextFile(Paths.txt('data/weekNames-' + Localizations.languageVar));
	...
	function selectWeek()
	{
		/*DialogueState.curWeek = curWeek;
		DialogueState.curPlaylist = weekData()[curWeek];
		DialogueState.curDifficulty = curDifficulty;*/
